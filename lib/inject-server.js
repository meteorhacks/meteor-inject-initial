...
Inject.rawModHtml('injectHeads', Inject._injectHeads);
Inject.rawModHtml('injectMeta', Inject._injectMeta);
Inject.rawModHtml('injectBodies', Inject._injectBodies);
Inject.rawModHtml('injectObjects', Inject._injectObjects);
